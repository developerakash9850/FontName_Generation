...
class BMPFile 
{
	...
	private final int bfOffBits = BITMAPFILEHEADER_SIZE + BITMAPINFOHEADER_SIZE + 8;
	...
	private final int biBitCount = 1;
	...
	private final int biClrUsed = 2;
	private final int biClrImportant = 2;
	...
	private final byte[] colorPalette = { 0, 0, 0, (byte) 255, (byte) 255,
